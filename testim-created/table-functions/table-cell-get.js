 ...
 *  Table - Cell Get
 *
 *      Get a specific cell within a specific row in a table and return its text and innerHTML
 * 
 *  Parameters
 *
 ...
 *      cellValueHTML (or <returnVariableName>HTML if specified) will contain actual cell innerHTML
 * 
 *  Notes
 * 
 *  Disclaimer
